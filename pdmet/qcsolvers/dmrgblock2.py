...
class DMRGBlock2Solver(BaseCASSolver):
    """DMRG solver using Block2 library"""
    ...
    def __init__(self, settings, is_KROHF=False):
        ...
        self.mc.natorb = True  # Check if this should be false for DMRG Solver
    ...
    def _run_nevpt2_mix(self, cas_norb, cas_nelec, e_tot):
        ...
        for i, solver in enumerate(solvers):
            ...
            res, tdm = self._nevpt2_from_mc_ci(
                mc_ci, ms, cs, es, nevpt2_roots[i], cas_norb
            )
